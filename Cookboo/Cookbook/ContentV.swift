        ...
        Form {
            Section(header: Text("Mini Apps")
                ...
                Section {
                    ...
                    */
                    ...
                    NavigationLink(destination: TunerView()) { Text("Tuner +").border(Color.yellow, width: 2)
                    }
                ...
                Section {
                    /*
                    NavigationLink(destination: PhaserView()) { Text("Phaser 移相器").foregroundColor(Color.red) }
            ...
            Section(header: Text("Effects")) {
                ...
                Section {
                    ...
                    NavigationLink(destination: PhaserView()) { Text("Phaser").foregroundColor(Color.red) }
                    NavigationLink(destination: PhaseLockedVocoderView()) { Text("Phase-Locked Vocoder") }
                    NavigationLink(destination: PlaybackSpeedView()) { Text("Playback Speed X").foregroundColor(Color.orange)
                    }
            ...
            Section(header: Text("Reverb")) {
                ...
                NavigationLink(destination: ReverbView()) { Text("Apple Reverb").foregroundColor(Color.green) }
